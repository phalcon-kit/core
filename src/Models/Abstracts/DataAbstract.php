...
abstract class DataAbstract extends AbstractModel implements DataAbstractInterface
{
    ...
    /**
     * Returns the value of the field "recordId"
     * Column: record_id
     * Attributes: NotNull | Numeric | Unsigned | Size(1) | Type(14)
     * @return mixed
     */
    ...
    /**
     * Sets the value of the field "recordId"
     * Column: record_id
     * Attributes: NotNull | Numeric | Unsigned | Size(1) | Type(14)
    ...
    /**
     * Returns the value of the field "columnId"
     * Column: column_id
     * Attributes: NotNull | Numeric | Unsigned | Size(1) | Type(14)
     * @return mixed
     */
    ...
    /**
     * Sets the value of the field "columnId"
     * Column: column_id
     * Attributes: NotNull | Numeric | Unsigned | Size(1) | Type(14)
