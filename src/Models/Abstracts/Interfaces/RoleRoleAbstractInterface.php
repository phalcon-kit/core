...
/**
 * @property RoleAbstractInterface $parententity
 * @property RoleAbstractInterface $ParentEntity
 * @method RoleAbstractInterface getParentEntity(?array $params = null)
 *
 * @property RoleAbstractInterface $childentity
 * @property RoleAbstractInterface $ChildEntity
 * @method RoleAbstractInterface getChildEntity(?array $params = null)
 *
 * @property UserAbstractInterface $createdbyentity
 * @property UserAbstractInterface $CreatedByEntity
 * @method UserAbstractInterface getCreatedByEntity(?array $params = null)
 */
interface RoleRoleAbstractInterface extends ModelInterface
{
    /**
