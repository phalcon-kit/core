 ...
 *
 * @property GroupRoleAbstractInterface[] $grouprolelist
 * @property GroupRoleAbstractInterface[] $GroupRoleList
 * @method GroupRoleAbstractInterface[] getGroupRoleList(?array $params = null)
 *
 * @property RoleAbstractInterface[] $rolelist
 * @property RoleAbstractInterface[] $RoleList
 * @method RoleAbstractInterface[] getRoleList(?array $params = null)
 *
 * @property GroupTypeAbstractInterface[] $grouptypelist
 * @property GroupTypeAbstractInterface[] $GroupTypeList
 * @method GroupTypeAbstractInterface[] getGroupTypeList(?array $params = null)
 *
 ...
 */
interface GroupAbstractInterface extends ModelInterface
{
    /**
