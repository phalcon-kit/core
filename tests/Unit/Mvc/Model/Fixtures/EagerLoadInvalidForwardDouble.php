...
class EagerLoadInvalidForwardDouble extends EagerLoadInvalidForwardParent
{
    use EagerLoad;

    public static function exposeFindWithByBroken(): ?array
    {
        return static::findWithBy('findByBroken', []);
    }
