...
- UUID factory: https://docs.phalcon.io/5.15/encryption-security/
...
- Response headers: https://docs.phalcon.io/5.15/response/
...
defaults. Phalcon 5.15 also exposes native UUID v1-v7 generation through
...
On Phalcon 5.15+, native UUID v7 is also available:
